      ...
      <div className="w-full max-w-4xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 font-sans mb-8 max-w-2xl mx-auto leading-relaxed">
            We&apos;re experiencing some technical difficulties in our digital
            kitchen. Our team is working hard to get everything back to normal,
            just like we do with our fresh bread every morning.
          </p>
          ...
          <div className="relative mb-12 max-w-md mx-auto">
            <Image
              ...
              alt="Herman's Modern Bakery café interior"
              width={400}
              height={300}
